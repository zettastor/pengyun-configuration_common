...
use constant CARD_TYPE_SAS => "CardTypeSas2308";

use constant SAS2IRCU_TOOL_PATH_CONFIG_NAME => "sas2ircu.tool.path";
use constant SAS2IRCU_TOOL_PATH_DEFAULT => "/opt/sas2308tool/sas2ircu";

use constant LSPCI_PATTERN_CONFIG_NAME => "sas2ircu.raid.pattern";
use constant LSPCI_PATTERN_DEFAULT => "LSI.+SAS2308";

use constant CARD_NAME => "Sas2308";
...
sub isCardTypeBelongToThisCard {
    my ($self, $cardType) = @_;
    return isSas2308CardType($cardType);
}

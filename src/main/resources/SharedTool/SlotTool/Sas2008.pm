...
use constant CARD_TYPE_SAS => "CardTypeSas2008";

use constant SAS2IRCU_TOOL_PATH_CONFIG_NAME => "sas2ircu2008.tool.path";
use constant SAS2IRCU_TOOL_PATH_DEFAULT => "/opt/sas2008tool/sas2ircu";

use constant LSPCI_PATTERN_CONFIG_NAME => "sas2ircu2008.raid.pattern";
use constant LSPCI_PATTERN_DEFAULT => "LSI.+SAS2008";

use constant CARD_NAME => "Sas2008";
...
sub isCardTypeBelongToThisCard {
    my ($self, $cardType) = @_;
    return isSas2008CardType($cardType);
}
...
sub isSas2008CardType {
    my ($cardType) = @_;
    return ($cardType eq CARD_TYPE_SAS);
}

sub hasSas2008Card {
    #>02:00.0 Serial Attached SCSI controller [0107]: LSI Logic / Symbios Logic SAS2008 PCI-Express Fusion-MPT SAS-2 [1000:0087] (rev 05)

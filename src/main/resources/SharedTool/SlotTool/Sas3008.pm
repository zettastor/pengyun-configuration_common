...
use constant CARD_TYPE_SAS => "CardTypeSas3008";

use constant SAS2IRCU_TOOL_PATH_CONFIG_NAME => "sas2ircu3008.tool.path";
use constant SAS2IRCU_TOOL_PATH_DEFAULT => "/opt/sas3008tool/sas2ircu";

use constant LSPCI_PATTERN_CONFIG_NAME => "sas2ircu3008.raid.pattern";
use constant LSPCI_PATTERN_DEFAULT => "LSI.+SAS3008";

use constant CARD_NAME => "Sas3008";
...
sub isCardTypeBelongToThisCard {
    my ($self, $cardType) = @_;
    return isSas3008CardType($cardType);
}
...
sub isSas3008CardType {
    my ($cardType) = @_;
    return ($cardType eq CARD_TYPE_SAS);
}

sub hasSas3008Card {
    #>02:00.0 Serial Attached SCSI controller [0107]: LSI Logic / Symbios Logic SAS3008 PCI-Express Fusion-MPT SAS-2 [1000:0087] (rev 05)
